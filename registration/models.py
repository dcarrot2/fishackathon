...
class Canoe(models.Model):
    ...
    manager_id = models.IntegerField(blank=True) #Not visible on form
    canoe_id = models.IntegerField(blank=True) #Not visible on form
    name_of_tech_staff = models.IntegerField(blank=True) #Not visible on form
    name_of_authority = models.CharField(max_length=40) #Not visible on form
    date_authorized = models.DateField(blank=True) #Not visible on form
